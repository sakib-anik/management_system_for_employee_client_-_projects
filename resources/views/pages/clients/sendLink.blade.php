                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                                ...
                                                <div class="input-group-prepend">
                                                    <div class="dropdown">
                                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                                            id="countryDropdown" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">
                                                            <span class="flag-icon flag-icon-us"></span>
                                                        </button>
                                                        <div class="dropdown-menu" aria-labelledby="countryDropdown">
                                                            <a class="dropdown-item" href="#" data-code="+1"
                                                                data-flag="us">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group mb-2">
                                                <select id="adminDepartment" name="department"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group mb-2">
                                                <select id="adminDesignation" name="designation"
                                                    class="form-select form-control" required>
                            ...
                            <div id="client" class="card">
                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-6">
                                            <label for="licenceNo" class="mb-0">Identity
                                                Number</label>
                                            <div class="input-group mb-2">
